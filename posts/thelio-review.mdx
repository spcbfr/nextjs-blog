...
date: "2022-11-03"
excerpt: "2 Months ago I got my Thelio Desktop and I have been using it daily ever since, today I wrote a review about, I hope you find it useful"
---
...
<figure className="rounded-xl overflow-hidden not-prose ">

  <img
    src="/thelio-in-garden.JPG" 
    alt="a picture of my thelio in a garden"
  />
  <figcaption className="not-prose text-sm p-2 text-zinc-300 bg-zinc-900">
    I took it outside for a quick photoshoot!
  </figcaption>
</figure>
...
<figure className="rounded-xl overflow-hidden not-prose ">
  ...
  />
  <figcaption className="not-prose text-sm p-2 text-zinc-300 bg-zinc-900">
    Pop OS Desktop, wallpaper found <a href="https://www.artstation.com/artwork/oArrvW" target="_blank" className="text-indigo-500">here</a>
  </figcaption>
</figure>
