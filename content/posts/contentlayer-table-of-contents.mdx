...
## Using computed fields to fetch the headings
...
and simply conditionally style the a tags based on the value of that data-attribute, the reason we converted the level into words is because appereantly data-attributes don't accept numbers as values.
...
### Adding toggleability (is that even a word lol)
